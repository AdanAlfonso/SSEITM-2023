		...
		<form action="pagina.php" method="GET" style="margin:3%; background-color:#F2F2F2; padding: 3%; margin-left: -10px;">
			...
			<!-- segunda fila -->        
					...
					<div class="col" >
						...
						<input  class="form-control"type="text" name="curp" maxlength="18" minlength="18" placeholder="Ej. FEPM890204HASRRN08">
					</div>
					<!-- tercera columna -->
					<div class="col">
			...
			<!-- tercera fila -->        
					...
					<div class="col">
						...
						<input  class="form-control"type="text" name="nDomicilio"  placeholder="Numero">
					...
					<div class="col">
						...
						<input  class="form-control"type="number" name="cp" min="" max=""  placeholder="Ej. 96536" >
					</div>
					<!-- cuarta columna -->
		    ...
		    <!-- cuarta fila -->        
					...
					<div class="col">
						...
						<input  class="form-control"type="number" name="telefonocelular" min="10" max="10"  placeholder="Ej. 9228347838" >
					</div>
					<!-- cuarta columna -->
					
					<div class="col">	
						<label style="color:#203c6c" for="validationTooltip01">Correo electronico</label>
						<input  class="form-control"type="email" name="correo"  placeholder="Ej. raton@gmail.com">
					</div>
			...
			<!-- quinta fila -->        
					...
					<div class="col">
						...
						<input  class="form-control"type="date" name="egreso" placeholder="Fecha de egreso">
					</div>
					<!-- cuarta columna -->
			...
			<!-- sexta fila -->
					...
					<div class="col" >
						...
						<input  class="form-control"type="text" name="otroidioma"  placeholder="opcional">
					</div>
					<!-- tercera columna -->
					<div class="col">
						<label style="color:#203c6c"  for="validationTooltip01">Codigo postal</label>
